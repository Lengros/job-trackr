...
This command **requires** the project directory as an argument via `/Users/alp/CursorProjects/Pet_products/job_trackr`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/alp/CursorProjects/Pet_products/job_trackr/.autoforge/prompts/app_spec.txt` and `/Users/alp/CursorProjects/Pet_products/job_trackr/.autoforge/prompts/initializer_prompt.md`

If `/Users/alp/CursorProjects/Pet_products/job_trackr` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/alp/CursorProjects/Pet_products/job_trackr/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/alp/CursorProjects/Pet_products/job_trackr/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/Users/alp/CursorProjects/Pet_products/job_trackr/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/Users/alp/CursorProjects/Pet_products/job_trackr/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/Users/alp/CursorProjects/Pet_products/job_trackr/.autoforge/prompts/`!
>
> **Files created:**
> - `/Users/alp/CursorProjects/Pet_products/job_trackr/.autoforge/prompts/app_spec.txt`
> - `/Users/alp/CursorProjects/Pet_products/job_trackr/.autoforge/prompts/initializer_prompt.md`
>
